...
<%@include file="../common/head.jsp"%>
    ...
    <!-- 编辑用户信息弹窗 -->
    <div id="edit_user" class="easyui-dialog" data-options="closed:true,buttons:[{text:'保存',iconCls:'icon-edit', handler:function(){editUserInfo();}},{text:'取消',iconCls:'icon-clear', handler: function(){$('#edit_user').dialog('close');}}]" title="编辑用户信息" style="width: 350px; height: 250px;">
        <form>
